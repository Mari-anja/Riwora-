...
type NewCustomersProps = NativeStackScreenProps<RootStackParamList, 'NewCustomers'>;

const NewCustomers: React.FC<NewCustomersProps> = ({ navigation }) => {
    ...
    useEffect(() => {
        const getCustomers = async () => {
            ...
            const data = await fetchNewCustomers(storedUserId);
            setCustomers(data);
            setLoading(false);
        };
    ...
    return (
        ...
        <View style={{ width: 32 }} /> 
            ...
            {loading ? (
                ...
                <Text style={styles.noCustomers}>No new customers found.</Text>
            )}

            <BottomNavigation navigation={navigation} activeTab="NewCustomers" />
        </View>
        </SafeAreaView>
    );
};
